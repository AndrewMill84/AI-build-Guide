...
<!-- Copy this file into your project folder and keep it updated. -->
...
| **Relevant Files** | `templates/idea-intake.md`, `workflow/01-idea-capture.md` |
| **Open Questions** | None yet |
| **Blockers** | None |
| **Last Completed Step** | Project created |
| **Next Step After Current** | Stage 2 — Clarification (agent asks clarifying questions) |
| **Started** | <!-- YYYY-MM-DD --> |
...
|---|---|---|---|
| <!-- YYYY-MM-DD --> | 1 — Idea Capture | human | Project started |
